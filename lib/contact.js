...
var toggleForm = function() {
  $("#contact form, #contact a").slideToggle(function() {
    resetForm();
  });
}

// Enables all form elements and shows submit button
...
Template.contact.events({
  ...
  // Hide or show form on click
  "click #contact a, click #contact form button[type=button]": toggleForm,
